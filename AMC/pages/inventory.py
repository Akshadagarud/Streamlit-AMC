...
def fetch_amc_data(selected_amc_id):
    try:
        amc_id = selected_amc_id.split(' - ')[1]  # Extract the amc_id from the concatenated string
...
def main():
    ...
    if not amc_ids:
        ...
        if selected_amc_id:
            ...
            st.write(amc_data.rename(columns={
                "amc_id": "AMC ID",
            ...
            st.write(inventory_data.rename(columns={
